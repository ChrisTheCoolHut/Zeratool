...
def test_pwn_win_func_32():
    ...
    properties['pwn_type']['results'] = overflowExploiter.exploitOverflow(test_file, properties, inputType=input_type)
...
def test_send_exploit():
    ...
    properties['send_results'] = overflowExploitSender.sendExploit(test_file,properties)
